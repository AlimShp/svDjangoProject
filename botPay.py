...
# Объект бота
bot = Bot(token="6453304515:AAFhNNw_Vasa4fP9nNqPXaY29YdHI3Cf7us")  #токен бота
ukassa = "381764678:TEST:77595"
dp = Dispatcher()
...
async def add_balance(callback: types.CallbackQuery):
    await callback.bot.send_invoice(
        ...
        description='Тестовый режим: для оплаты используйте данные тестовой карты: 1111 1111 1111 1026, 12/22, CVC 000.',
        provider_token=ukassa,  # ukassa - токен платежной системы, здесь тестовый
        payload='add_balance',
